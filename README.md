...
is required to have, so the ten typefaces resolve to Times for the four serif
choices and Helvetica for the six sans choices. The serif or sans decision is
preserved, the DOCX carries the exact typeface name, and the live preview renders
all ten distinctly. This is asserted as the contract rather than hidden.
